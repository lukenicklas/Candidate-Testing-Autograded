...
let numberCorrectAnswers = []
  ...
  console.log(`${candidateAnswers[i]} is correct! You're a genius.`)
  ...
  console.log(`>>> Overall Grade: >>> ${grade}% (${numberCorrectAnswers} of ${numberQuizQuestions} responses correct) <<<`);
  if (grade >= 80) 
